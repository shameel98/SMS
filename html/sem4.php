...
$sql = "INSERT INTO sem4 (reg_no, sem4subt1, sem4subt2, sem4subt3, sem4subt4, sem4subt5, sem4subt6, sem4subt7, sem4subp1, sem4subp2,  sem4subi1, sem4subi2, sem4subi3, sem4subi4, sem4subi5, sem4subi6, sem4subpi1, sem4subpi2, sem4backs, sem4total, sem4obtained) VALUES ('$temp', '$sem1st1', '$sem1st2', '$sem1st3', '$sem1st4', '$sem1st5', '$sem1st6', '$sem1si7', '$sem1sp1', '$sem1sp2','$sem1si1','$sem1si2','$sem1si3','$sem1si4','$sem1si5','$sem1si6','$sem1spi1','$sem1spi2', '$bcount', '$total', '$sec')";
if(mysqli_query($link, $sql)){
    echo "<script type='text/javascript'>alert('RECORD SUCCESFULLY UPDATED:REDIRECTING IN 5 SECONDS')</script>";
	header("refresh:5;url=sem5.php");
}
	else
	{
...
<form name="sem1" action="sem4.php" method="post" onSubmit="return check()">
	<div class="info">SEMESTER 4<br><br/>
	...
	<input type="text" class="text1" placeholder="UNIX" name="sem1t3" id="sem1t3" onBlur="valid('sem1t3')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 70">
	...
	<input type="text" class="text1" placeholder="VISUAL PROGRAMMING" name="sem1t4" id="sem1t4" onBlur="valid('sem1t4')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 70">
	...
	<input type="text" class="text1" placeholder="OPERATION RESEARCH" name="sem1t5" id="sem1t5" onBlur="valid('sem1t5')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 100">
	...
	<input type="text" class="text1" placeholder="PERSONALITY DEVELOPMENT" name="sem1t6" id="sem1t6" onBlur="valid('sem1t6')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 70">
	...
	<input type="text" class="text1" placeholder="VB PRACTICALS" name="sem1p1" id="sem1p1" onBlur="valid('sem1p1')" onKeyPress="return isnumkey(event)">
	...
	<input type="text" class="text1" placeholder="UNIX PRACTICALS" name="sem1p2" id="sem1p2" onBlur="valid('sem1p2')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 35">
