...
$sql = "INSERT INTO sem3 (reg_no, sem3subt1, sem3subt2, sem3subt3, sem3subt4, sem3subt5, sem3subt6, sem3subt7, sem3subp1, sem3subp2,  sem3subi1, sem3subi2, sem3subi3, sem3subi4, sem3subi5, sem3subi6, sem3subpi1, sem3subpi2, sem3backs, sem3total, sem3obtained) VALUES ('$temp', '$sem1st1', '$sem1st2', '$sem1st3', '$sem1st4', '$sem1st5', '$sem1st6', '$sem1si7', '$sem1sp1', '$sem1sp2','$sem1si1','$sem1si2','$sem1si3','$sem1si4','$sem1si5','$sem1si6','$sem1spi1','$sem1spi2', '$bcount', '$total', '$sec')";
if(mysqli_query($link, $sql)){
    echo "<script type='text/javascript'>alert('RECORD SUCCESFULLY UPDATED:REDIRECTING IN 5 SECONDS')</script>";
	header("refresh:5;url=sem4.php");
}
	else
	{
...
<form name="sem1" action="sem3.php" method="post" onSubmit="return check()">
	<div class="info">SEMESTER 3<br><br/>
	...
	<input type="text" class="text1" placeholder="OOPS USING C++" name="sem1t3" id="sem1t3" onBlur="valid('sem1t3')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 70">
	...
	<input type="text" class="text1" placeholder="FINANCIAL ACCOUNTING" name="sem1t4" id="sem1t4" onBlur="valid('sem1t4')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 70">
	...
	<input type="text" class="text1" placeholder="OPERATING SYSTEM" name="sem1t5" id="sem1t5" onBlur="valid('sem1t5')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 100">
	...
	<input type="text" class="text1" placeholder="CULTURE AND DIVERSITY" name="sem1t6" id="sem1t6" onBlur="valid('sem1t6')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 70">
	...
	<input type="text" class="text1" placeholder="TALLY PRACTICALS" name="sem1p2" id="sem1p2" onBlur="valid('sem1p2')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 35">
