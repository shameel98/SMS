...
$sql = "INSERT INTO sem2 (reg_no, sem2subt1, sem2subt2, sem2subt3, sem2subt4, sem2subt5, sem2subt6, sem2subt7, sem2subp1, sem2subp2,  sem2subi1, sem2subi2, sem2subi3, sem2subi4, sem2subi5, sem2subi6, sem2subpi1, sem2subpi2, sem2backs, sem2total, sem2obtained) VALUES ('$temp', '$sem1st1', '$sem1st2', '$sem1st3', '$sem1st4', '$sem1st5', '$sem1st6', '$sem1si7', '$sem1sp1', '$sem1sp2','$sem1si1','$sem1si2','$sem1si3','$sem1si4','$sem1si5','$sem1si6','$sem1spi1','$sem1spi2', '$bcount', '$total', '$sec')";
if(mysqli_query($link, $sql)){
   echo "<script type='text/javascript'>alert('RECORD SUCCESFULLY UPDATED:REDIRECTING IN 5 SECONDS')</script>";
	header("refresh:5;url=sem3.php");
}
	else
	{
...
<form name="sem1" action="sem2.php" method="post" onSubmit="return check()">
	<div class="info">SEMESTER 2<br><br/>
	...
	<input type="text" class="text1" placeholder="DATA STRUCTURES" name="sem1t3" id="sem1t3" onBlur="valid('sem1t3')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 70">
	...
	<input type="text" class="text1" placeholder="DBMS" name="sem1t4" id="sem1t4" onBlur="valid('sem1t4')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 70">
	...
	<input type="text" class="text1" placeholder="NUMERIC MATHS" name="sem1t5" id="sem1t5" onBlur="valid('sem1t5')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 100">
	...
	<input type="text" class="text1" placeholder="INDIAN CONSTITUTION" name="sem1t6" id="sem1t6" onBlur="valid('sem1t6')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 70">
	...
	<input type="text" class="text1" placeholder="DATA STRUCTURES PRACTICALS" name="sem1p1" id="sem1p1" onBlur="valid('sem1p1')" onKeyPress="return isnumkey(event)">
	...
	<input type="text" class="text1" placeholder="DBMS PRACTICALS" name="sem1p2" id="sem1p2" onBlur="valid('sem1p2')" onKeyPress="return isnumkey(event)">
	<input type="label" disabled="disabled" class="text2" name="sem1hin" value="MAX 35">
