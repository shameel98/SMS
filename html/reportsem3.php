...
$sql = "SELECT * FROM sem3,register where sem3.reg_no=register.reg_no order by sem3.sem3obtained desc";
$result = mysqli_query($con,$sql)or die(mysqli_error($con));
$i=1;
echo "<h2 style='color:white;text-align:center;'>SEMESTER THREE REPORT RANKING WISE</h2>";
...
while($row = mysqli_fetch_array($result)) {
    $regno = $row['reg_no'];
    $s1ob = $row['sem3obtained'];
    $s1back = $row['sem3backs'];
