...
$sql = "SELECT * FROM sem4,register where sem4.reg_no=register.reg_no order by sem4.sem4obtained desc";
$result = mysqli_query($con,$sql)or die(mysqli_error($con));
$i=1;
echo "<h2 style='color:white;text-align:center;'>SEMESTER FOUR REPORT RANKING WISE</h2>";
...
while($row = mysqli_fetch_array($result)) {
    $regno = $row['reg_no'];
    $s1ob = $row['sem4obtained'];
    $s1back = $row['sem4backs'];
